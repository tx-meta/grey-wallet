...
import { SupabaseSignUpUseCase, SupabaseSignUpRequest } from '../../domain/use_cases/sign-up-supabase';
import { SupabaseAuthService } from '../../infrastructure/external_apis/supabase-auth';
import logger from '../../shared/logging';

export class SupabaseAuthController {
  constructor(
    private supabaseSignUpUseCase: SupabaseSignUpUseCase,
  ...
  async signUp(req: Request, res: Response): Promise<void> {
    try {
      const signUpRequest: SupabaseSignUpRequest = {
      ...
      const result = await this.supabaseSignUpUseCase.execute(signUpRequest);
